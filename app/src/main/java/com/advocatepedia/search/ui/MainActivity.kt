                ...
                retrofitData2.enqueue(object : Callback<MyData?> {
                    ...
                    override fun onResponse(call: Call<MyData?>, response: Response<MyData?>) {
                        ...
                        if (productList != null) {
                            ...
                            val shareButton = findViewById<Button>(com.advocatepedia.search.R.id.shareButton2) // Replace R.id.shareButton with your actual button ID
        ...
        retrofitData3.enqueue(object : Callback<MyData?> {
            ...
            override fun onResponse(call: Call<MyData?>, response: Response<MyData?>) {
                ...
                if (productList != null && productList.isNotEmpty()) {
                    ...
                    val descriptionTextView = findViewById<TextView>(com.advocatepedia.search.R.id.description)
                    val thumbnailImageView = findViewById<ImageView>(com.advocatepedia.search.R.id.photo)
                ...
                retrofitData5.enqueue(object : Callback<MyData?> {
                    ...
                    override fun onResponse(call: Call<MyData?>, response: Response<MyData?>) {
                        ...
                        if (productList != null) {
                            ...
                            val productNames = productList.joinToString(separator = "\n") { it.news }
                            val shareButton = findViewById<Button>(com.advocatepedia.search.R.id.shareButton4) // Replace R.id.shareButton with your actual button ID
                            shareButton.setOnClickListener {
                                val shareIntent = Intent(Intent.ACTION_SEND)
                                shareIntent.type = "text/plain"
                                shareIntent.putExtra(Intent.EXTRA_TEXT, productNames)
